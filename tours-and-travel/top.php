	 <div class="header-top">
		 <!--container-->
		  <div class="container">
			 <div class="top-nav">
						<div class="logo">
							<a href="index.php"  onclick="javascript:window.open('index.php','_self')"><img src="../tours-and-travel-master/images/TRAVEL_TOURISM_LOGO-01.jpg" width="100px" hight="100px"  id="section-1" class="img-responsive" alt=""/></a>
						</div>
						<div class="menu">
						<ul id="nav">
